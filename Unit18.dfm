object Form18: TForm18
  ...
  Caption = 'PHOBOS DTI CONTROL - NET SEND'
  ClientHeight = 141
  ClientWidth = 481
  Color = clBtnFace
  ...
  object ADOQuery1: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'select * from controle_ips order by usuario')
    Left = 440
    Top = 8
    ...
    object ADOQuery1nome_computador: TWideStringField
    ...
    object ADOQuery1ip: TWideStringField
      FieldName = 'ip'
      Size = 50
    end
    object ADOQuery1obs: TMemoField
      FieldName = 'obs'
      BlobType = ftMemo
    end
    ...
    object ADOQuery1localz: TWideStringField
      FieldName = 'localz'
      Size = 50
    end
  end
